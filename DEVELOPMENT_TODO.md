...
**最后更新**：2026-05-19（已同步第一阶段、百万行索引修复、chunk 填充与按位置查询范围裁剪、UTF-8 offset、read_line_cut、UTF-16 offset 重扫、UTF-16BE/UTF-32 行扫描补测、加载状态 API、Condvar 扫描等待与 C FFI 核心绑定）
**维护者**：开发团队
