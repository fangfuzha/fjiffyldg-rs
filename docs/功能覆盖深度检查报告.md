...
| 扫描进行中查询                             | `GetFileLinePos` 可见已扫描前缀；`GetFileLineIndex` 仍不可用                      | ✅ 已对齐     | `get_file_line_pos_exposes_scanned_prefix_while_scanning`、`get_file_line_index_stays_unavailable_while_scanning`           |
